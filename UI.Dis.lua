local uieee = game.CoreGui:FindFirstChild("FkJfJ+j.rAu(t(p4Wo:E")
if uieee then
   uieee:Destroy()
end
wait()
...
Discord.Name = "FkJfJ+j.rAu(t(p4Wo:E"
...
function DiscordLib:Window(text)
    ...
    local Discordui = game.CoreGui:FindFirstChild("FkJfJ+j.rAu(t(p4Wo:E")
	...
	function ServerHold:Server(text, img)
		...
		function ChannelHold:Channel(text)
			...
			function ChannelContent:line()
				...
				Seperator2.Position = UDim2.new(0, 0, 0, 2)
			...
			function ChannelContent:Label(text)
				...
				Button.Name = "Button"
				Button.Parent = ChannelHolder
				Button.BackgroundColor3 = Color3.fromRGB(100, 106, 117)
				Button.Size = UDim2.new(0, 401, 0, 30)
				Button.AutoButtonColor = false
				Button.Font = Enum.Font.Gotham
				Button.TextColor3 = Color3.fromRGB(255, 255, 255)
